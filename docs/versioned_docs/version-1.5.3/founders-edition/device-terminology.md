...
<div style={{ textAlign: 'center', margin: '1rem 0' }}>
  ...
  />
  <p style={{ fontStyle: 'italic' }}>Front-facing display of the Founders Edition unit</p>
</div>
...
<div style={{ textAlign: 'center', margin: '1rem 0' }}>
  <img
    ...
    style={{ maxWidth: '90%', borderRadius: '12px', boxShadow: '0 6px 18px rgba(0,0,0,0.15)' }}
  />
  <p style={{ fontStyle: 'italic' }}>Internal layout of the rear components</p>
</div>
...
A compact **radio-frequency antenna** is mounted onto the compute module and enables **Bluetooth connectivity** with the [tinyLeague™ Hub app](/docs/tinyLeague-app/app-installation). This component ensures fast, reliable signal performance from several meters away.
...
For recommended mounting options and a closer look at how to reliably mount your units, check out the [Shot Clock Stands documentation](/docs/shotclock-stands/introduction)
