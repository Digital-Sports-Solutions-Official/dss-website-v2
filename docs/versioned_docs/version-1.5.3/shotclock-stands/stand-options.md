...
To help teams, referees, and event organizers mount their **Founders Edition Shot Clocks**, we’ve identified a extremely simple tabletop stand, and two practical stand-building paths. All are fully compatible with the unit’s built-in **¾" NPT flange**, and both builds can be sourced using common materials.

Choose based on your needs, time, and available tools.

---

### 🖨️ Easy Option – 3D-Printed Tabletop Stand
...
Click here to get started with the [tabletop stand](/docs/shotclock-stands/tabletop-stand).

---

### ✅ Recommended Option – Minimal Work, Modern Design

If you’re looking for a fast and clean solution with minimal hardware work, this is the path for you.

- 🛒 **Buy the parts from Amazon**
...
### 🛠 Reliable Option – Traditional DIY Build
...
This path is for leagues with workshop access and technical skills, or for teams that can leave the stand setup for prolonged periods of time.

:::note
While this option requires more work, it also provides a lot more stability and protection against falling over. Since the stands make these units over 7ft tall, falls are a **serious concern**.
:::

Click here to get started with the [reliable stand build](/docs/shotclock-stands/stand-option-2/build-overview).

---

### 📏 Compatibility Reminder

Both options use the built-in **¾" NPT threaded flange** at the base of each Founders Edition unit. This is a standard in both:
...
**Digital Sports Solutions (DSS) is not responsible or liable for any damage** to Founders Edition shot clock units resulting from improper assembly, handling, or use of third-party stand components.

By choosing to build or use a custom stand, you acknowledge that:
