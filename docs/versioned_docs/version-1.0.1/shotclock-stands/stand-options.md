...
To help teams, referees, and event organizers mount their **Founders Edition Shot Clocks**, we’ve identified two practical stand-building paths. Both are fully compatible with the unit’s built-in **¾" NPT flange**, and both can be sourced using common materials.
