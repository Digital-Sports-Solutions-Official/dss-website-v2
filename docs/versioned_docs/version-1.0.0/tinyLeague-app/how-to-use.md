...
<div style={{ textAlign: 'center', marginTop: '1rem', marginBottom: '1rem' }}>
  <img
    src={useBaseUrl('https://raw.githubusercontent.com/Digital-Sports-Solutions-Official/DSS-assets/main/img/App_Screenshots/tL_hub_timer_ss.png')}
    alt="TinyLeague Shot Clock Timer Screenshot"
    style={{ maxWidth: '90%', borderRadius: '8px', boxShadow: '0 4px 12px rgba(0,0,0,0.1)' }}
  />
  <p style={{ fontStyle: 'italic' }}>Main timer interface in the tinyLeague™ Hub app</p>
</div>
...
- Undo has two modes, **Regular** and **True Undo**. Please see the settings docuementation for an in-depth guide on the difference between these two.
...
#### A simple video example of how these buttons can be used to control the clock.

<div style={{ position: 'relative', paddingBottom: '56.25%', height: 0, overflow: 'hidden', marginBottom: '2rem' }}>
  <iframe
    src="https://www.youtube.com/embed/995DAuYPqQ0?si=q1sWPI8Ho1g9a4I6"
    title="YouTube video"
    frameBorder="0"
